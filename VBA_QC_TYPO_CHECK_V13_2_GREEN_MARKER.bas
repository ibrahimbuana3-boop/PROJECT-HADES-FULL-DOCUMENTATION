...
'=========================================================
' PROJECT HADES — QC TYPO CHECK V13.2 SMART PAIR REPORT
' CorelDRAW 2021 VBA
'
' BASE:
...
' - Tidak mengganti nama shortcut lama: QC_TYPO_CHECK dan HADES_QC_TYPO_REPORT tetap sama.
'
' UPDATE V13.2G GREEN FAIL PANEL MARKER:
' - Nama shortcut tetap sama: QC_TYPO_CHECK dan HADES_QC_TYPO_REPORT.
